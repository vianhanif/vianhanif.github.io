...
Three weeks ago I [published a post about building memory into 9router](posts/2026-07-25-building-memory-into-9router-a-proxy-layer-experiment.md). The system worked — load, inject, extract — but I already knew it wasn't going to stay that way.
...
- **July 25:** [Published the original post](posts/2026-07-25-building-memory-into-9router-a-proxy-layer-experiment.md) about the flat-file memory system
...
### Sources
- [Part 1: Building Memory Into 9router](posts/2026-07-25-building-memory-into-9router-a-proxy-layer-experiment.md)
