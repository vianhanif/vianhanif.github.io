...
I lived with these walls for months. The ecosystem proved something important: multi-agent orchestration was possible, and it was powerful. But it also proved the tool I was building on needed fundamental changes I couldn't make from the outside. I wrote more about the TUI wall and the cost tradeoffs in [OpenCode: The $10/mo TUI](./2026-05-27-opencode-ten-bucks.md). The limits I hit here are exactly what [The Router My Colleague Showed Me](./2026-06-10-the-router-my-colleague-showed-me.md) approached from a different angle — but that's the next story.
