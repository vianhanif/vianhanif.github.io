...
I closed it and went back to OpenCode without a second thought (see [Warp Tried to Sell Me AI Again](/posts/warp-tried-to-sell-me-ai/)). This was around the time I was building the `/delegate` system, hacking orchestration on top of a TUI. Warp wasn't on my radar.
